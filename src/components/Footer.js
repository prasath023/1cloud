    ...
    <div className='w-screen heading border-t-2 lg:pt-14 pt-8  text-gray-200'>
      ...
      <LogoLink/>
       ...
       <ul className='lg:text-xl font-semibold pb-5 lg:py-14 '>
        ...
        <li className='my-3  lg:my-7'>
        <Link to="services" spy={true} smooth={true} offset={0} className="cursor-pointer" duration={700} >Services</Link>
</li>
        <li className='my-3  lg:my-7'>
        <Link to="support" spy={true} smooth={true} offset={-100} className="cursor-pointer" duration={1000} >Supported Formats</Link>
        </li>
        <li className='my-3  lg:my-7'>
       ...
       <FooterLinks/>
        ...
        <div className='lg:px-16 w-screen text-xs lg:text-base'>
